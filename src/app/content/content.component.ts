...
export class ContentComponent {
    ...
    ngOnInit(){
      ...
      this._route.params.subscribe((param)=>{
        ...
        if ( this.catId !== +param.categoryId ) {
            ...
            this._list.list(this.catId || 1, this.query).subscribe((v: any[])=>{
              ...
              this.lists = v;
              if( v.length != 0){
                let data = find(v, { id: this.listId });
      ...
      this.state.search.skip(1).subscribe((q: string)=>{
        this.query = q;
        this.search();
      });
    }
    ...
    update($event: any){
      console.log('update');
      let ind = findIndex(this.lists, (list: any)=>{
